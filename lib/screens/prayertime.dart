...
// import 'package:logger/logger.dart'; // ✨ New import
...
//     // Schedule weekly Salawat notification at 7PM EAT
...
//     logger.i("Attempting to get device location..."); // ✨
//     try {
...
//       logger.d(
//         "📍 Position found: ${position.latitude}, ${position.longitude}",
//       ); // ✨
...
//           logger.i("📍 Location set to: $_city, $_country"); // ✨
//         });
//       }
//     } catch (e, s) {
//       // ✨ Added stack trace `s`
//       logger.e("❌ Failed to get location", error: e, stackTrace: s); // ✨
//       setState(() {
...
//     };
//     logger.d("Calculated Prayer Times (Map): $times"); // ✨
...
//     logger.i("⏰ Next prayer determined: $next"); // ✨
...
//     logger.i("Scheduling all prayer notifications..."); // ✨
...
//     // ... (rest of the code is unchanged, no logging needed here as it runs every second)
