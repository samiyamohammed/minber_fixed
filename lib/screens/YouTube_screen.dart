    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          // ✅ UI/UX UPDATE: Modern, theme-aware TabBar
          bottom: TabBar(
    ...
    return FutureBuilder<List<Video>>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          return const _VideoListShimmer(); // ✅ UI/UX UPDATE
        }
...
class _PlaylistsTabState extends State<PlaylistsTab> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        // ✅ UI/UX UPDATE: Cleaner "Back" chip
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return _selectedPlaylist == null
                    ...
                    : const _VideoListShimmer(); // ✅ UI/UX UPDATE
              }
              if (snapshot.hasError) {
                return const _EmptyState(
                    icon: Icons.error_outline,
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          // ✅ UI/UX UPDATE: Modernized video list card
          elevation: 0,
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          // ✅ UI/UX UPDATE: Modernized playlist grid card with gradient
          elevation: 0,
